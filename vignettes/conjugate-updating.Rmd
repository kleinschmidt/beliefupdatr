...
fit_inc_4 <- rstan::stan(file = model_filename("conj_id_lapsing_sufficient_stats_fit.stan"),
                         data = d_stan_inc_4,
                         iter = 1000, chains = 4, init=0)

print(fit_inc_4, digits=1, pars=c('kappa_0', 'nu_0', 'mu_0', 'sigma_0', 'lapse_rate'))
...
fit_inc_10 <-
  ...
  beliefupdatr::prepare_data_incremental_suff_stats(test=d,
                                                    ...
                                                    group = 'bvotCond',
                                                    n_blocks = 10) %>%
  rstan::stan(file = model_filename("conj_id_lapsing_sufficient_stats_fit.stan"),
              data = .,
              iter = 1000, chains = 4, init = 0) %T>%
